...
class HelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StaticPageScaffold(
      title: localize(lang, 'Bantuan', 'Help'),
      children: [
        StaticPageHeading(
            localize(lang, 'Bagaimana cara menjelajahi dewa?', 'How do I browse gods?')),
        StaticPageParagraph(
          localize(lang,
        ...
        StaticPageHeading(localize(lang,
        ...
        StaticPageHeading(localize(lang, 'Apa itu tab Stories?', 'What is the Stories tab?')),
        StaticPageParagraph(
          localize(lang,
        ...
        StaticPageHeading(
            localize(lang, 'Bagaimana cara main kuis?', 'How do I take a quiz?')),
        StaticPageParagraph(
          localize(lang,
        ...
        StaticPageHeading(localize(lang, 'Apa itu Adu Dewa?', 'What is God Battle?')),
        StaticPageParagraph(
          localize(lang,
        ...
        StaticPageHeading(localize(lang, 'Bisa ganti bahasa?', 'Can I switch languages?')),
        StaticPageParagraph(
          localize(lang,
